...
// ab hum array pe foreach ki jagah map ka use krenge .. map humko return krke dega utne hi elements jitne productsData ke ander hai
...
// kyuki product card bhi kuch return krega isliye yaha bhi return likha  
      })
     }
    </div>
    </div>
